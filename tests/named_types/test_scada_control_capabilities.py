"""Tests scada.control.capabilities type, version 001: the sema example round-trips
...
the cycler, a DAC, and the two interior command nodes."""
...
EXAMPLE = {'CommandInterfaces': [{'ActorName': 'zone1-bedrooms-ops-relay',
                        ...
                        'Version': '000'},
                       {'ActorName': 'pico-cycler',
                        'Commands': [{'Event': 'RebootPicos',
                                      'ToState': 'RelayOpening',
                                      'TypeName': 'gw.command.transition',
                                      'Version': '000'}],
                        'EventType': 'reboot.picos',
                        'StateType': 'pico.cycler.state',
                        'TypeName': 'gw.command.interface',
                        'Version': '000'},
                       {'ActorName': 'hp-boss',
                        ...
                        'TypeName': 'gw.command.interface',
                        'Version': '000'}],
 'CommandNodes': [{'ActorClass': 'PicoCycler',
                   'ActorHierarchyName': 's.pico-cycler',
                   'DisplayName': 'Pico Cycler',
                   'Handle': 'admin.pico-cycler',
                   'Name': 'pico-cycler',
 ...
 'RelayNodes': [{'ActorClass': 'Relay',
                ...
                {'ActorClass': 'Relay',
                 ...
                 'Handle': 'admin.pico-cycler.vdc-relay',
                 'Name': 'vdc-relay',
