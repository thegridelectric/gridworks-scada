...
class LocalControlTouBase(ShNodeActor):
    ...
    def initialize_actuators(self):
        ...
        try:
            ...
            self.set_010_defaults(boss_node=self.command_node)
    ...
    def scada_blind_actuator_actions(self) -> None:
        ...
        """
        self.turn_off_store_pump(boss_node=self.scada_blind_node)
    ...
    def backup_actuator_actions(self) -> None:
        ...
        """
        self.turn_off_store_pump(boss_node=self.backup_node)
