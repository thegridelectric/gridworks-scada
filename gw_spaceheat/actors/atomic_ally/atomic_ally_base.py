...
class AtomicAllyBase(ScadaActor):
    """Base class for AtomicAlly strategies. Contains common functionality that all strategies share."""
    ...
    def update_relays(self) -> None:
        """Strategy-specific relay update logic"""
        raise NotImplementedError
